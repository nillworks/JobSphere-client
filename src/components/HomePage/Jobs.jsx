...
import { SlideUp, StaggerContainer, StaggerItem, FadeIn } from '@/components/Shared/MotionWrapper';
  ...
  return (
    <section id="jobs" className="py-12 sm:py-16 md:py-24">
      <SectionShell>
        ...
        <StaggerContainer className="grid gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {limitJobs.map(job => (
