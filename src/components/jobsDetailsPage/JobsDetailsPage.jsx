...
const JobsDetailsPage = ({ singleJob }) => {
  ...
  return (
    <div className="mx-auto pt-20 max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      {/* Header Section */}
      <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-8 shadow-sm dark:border-[#1d242d] dark:bg-[#11151a] md:p-12">
        <div className="absolute left-0 top-0 h-2 w-full bg-gradient-to-r from-[#ff9a86] to-[#bf7465]" />
        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          <div className="flex-1">
            ...
            <h1 className="mb-4 text-3xl font-bold tracking-tight text-slate-900 dark:text-white md:text-4xl lg:text-5xl">
      ...
      <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-8 lg:col-span-2">
          {/* About the role */}
          {responsibilities && (
            <div className="rounded-2xl border border-slate-200 bg-white p-8 dark:border-[#1d242d] dark:bg-[#11151a]">
        ...
        <div className="space-y-8">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-[#1d242d] dark:bg-[#11151a]">
